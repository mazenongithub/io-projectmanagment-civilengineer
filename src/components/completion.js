...
class Completion {
    ...
    handleopendatemenu() {
        if (this.state.completioncalender === 'open') {
            return (closeDateMenu())
        } else if (this.state.completioncalender === 'close') {
            return (openDateMenu())
        }
    ...
    yeardown() {
        ...
        if (myuser) {
            ...
            if (this.state.activemilestoneid) {
                ...
                let i = pm.getprojectkey.call(this);
                let j = this.getactivemilestonekey()
                myuser.projects.myproject[i].projectmilestones.mymilestone[j].completion = newtime;
                this.props.reduxUser(myuser)
                this.setState({ render: 'render' })
            }
            else {
    ...
    getvalue() {
        ...
        if (this.state.activemilestoneid) {
            ...
            let mymilestone = this.getactivemilestone();
            value = mymilestone.completion;


        }
        else {
            value = makeDatefromObj(this.state.completion)
    ...
    showdateforcalendar() {
        if (this.state.activemilestoneid) {
            ...
            return (formatDateforCalendarDisplay(this.state.completion))
                ...
                <div style={{ ...styles.flex1, ...styles.calenderContainer }}>
                    ...
                    <div style={{ ...styles.dateinContainer, ...styles.generalFlex, ...styles.bottomMargin15 }}>
                        <div style={{ ...styles.flex5, ...regularFont, ...styles.generalFont }}>
                            Milestone Completion <br /> <input type="date"
