                    ...
                    <div style={{ ...styles.flex1 }}>
                        ...
                        <div style={{ ...styles.generalFlex, ...styles.bottomMargin15 }}>
                            <div style={{ ...styles.flex1,  ...styles.alignCenter}}>
                                <span style={{...styles.boldFont,...headerFont }}>/{project.title}</span> <br />
                                <span style={{...styles.boldFont,...headerFont }}>Specifications</span>  <br />
                                <span style={{...styles.boldFont,...headerFont }}>{csi.csi} - {csi.title}</span>
                            </div>
                        </div>
