...
import { actualmajorDownIcon, removeIcon, saveallprojectactual, ClearActiveActualLabor, ActualDateArrowUp, ActualDateArrowDown, editLaborIcon, deleteLaborIcon } from './svg'
import {
            ...
            return (
                <div className="general-flex">
                    <div className="regualrFont flex-1 align-contentCenter">
                        ...
                        <button className="general-button btn-clearlaborid" onClick={event => { this.clearlaborid(event) }}>{ClearActiveActualLabor()} </button>
                    </div>
                </div>
            )
        }
                        ...
                        <div className="flex-1">
                            ...
                            <div className="general-flex">
                                ...
                                <div className="flex-1 timedisplay-container align-contentCenter">
                                    <button className="general-button majorDownIcon" onClick={() => { this.activetimeincalendar() }}>{actualmajorDownIcon()}</button>
                                </div>
                            </div>
                    ...
                    <div className="general-flex">
                        <div className="flex-1 showBorder timecell-container">
                            ...
                            <div className="timecell-module showBorder align-contentCenter">
                                <button className="general-button time-button" onClick={event => { this.timeinmonthup(event) }}>{ActualDateArrowUp()}</button>
                            </div>
                            <div className="timecell-module showBorder align-contentCenter">
                                <input type="text" className="timeinput-field align-contentCenter titleFont" value={this.gettimeinmonth()} />
                            </div>
                            <div className="timecell-module showBorder align-contentCenter">
                                <button className="general-button time-button" onClick={event => { this.timeinmonthdown(event) }}> {ActualDateArrowDown()}</button>
                            </div>
                        ...
                        <div className="flex-1 showBorder timecell-container align-contentCenter">
                            <div className="timecell-module showBorder">
                                <button className="general-button time-button" onClick={event => { this.increasetimeinbyinc(event, (1000 * 60 * 60 * 24)) }}>{ActualDateArrowUp()}</button>
                            </div>
                            <div className="timecell-module showBorder align-contentCenter">
                                <input type="text" className="timeinput-field align-contentCenter titleFont" value={this.gettimeinday()} />
                            </div>
                            <div className="timecell-module showBorder align-contentCenter">
                                <button className="general-button time-button" onClick={event => { this.decreasetimeinbyinc(event, (1000 * 60 * 60 * 24)) }}> {ActualDateArrowDown()}</button>
                            </div>

                        </div>
                        <div className="flex-1 showBorder timecell-container align-contentCenter">
                            <div className="timecell-module showBorder">
                                <button className="time-button general-button" onClick={event => { this.timeinyearup(event) }}>{ActualDateArrowUp()}</button>
                            </div>
                            <div className="timecell-module showBorder align-contentCenter">
                                <input type="text" className="timeinput-field align-contentCenter titleFont" value={this.gettimeinyear()} />
                            </div>
                            <div className="timecell-module showBorder align-contentCenter">
                                <button className="time-button general-button" onClick={event => { this.timeinyeardown(event) }}> {ActualDateArrowDown()}</button>
                            </div>
                        </div>

                        <div className="flex-1 showBorder timecell-container">
                            <div className="timecell-module showBorder align-contentCenter">
                                <button className="time-button general-button align-contentCenter" onClick={event => { this.increasetimeinbyinc(event, (1000 * 60 * 60)) }}>{ActualDateArrowUp()}</button>
                            </div>
                            <div className="timecell-module showBorder align-contentCenter">
                                <input type="text" className="timeinput-field align-contentCenter titleFont" value={this.gettimeinhours()} />
                            </div>
                            <div className="timecell-module showBorder align-contentCenter">
                                <button className="time-button general-button align-contentCenter" onClick={event => { this.decreasetimeinbyinc(event, (1000 * 60 * 60)) }}> {ActualDateArrowDown()}</button>
                            </div>
                        </div>

                        <div className="flex-1 showBorder timecell-container">
                            <div className="timecell-module showBorder align-contentCenter">
                                <button className="time-button general-button align-contentCenter" onClick={event => { this.increasetimeinbyinc(event, (1000 * 60)) }}>{ActualDateArrowUp()}</button>
                            </div>
                            <div className="timecell-module showBorder align-contentCenter">
                                <input type="text" className="timeinput-field align-contentCenter titleFont" value={this.gettimeinminutes()} />
                            </div>
                            <div className="timecell-module showBorder align-contentCenter">
                                <button className="time-button general-button align-contentCenter" onClick={event => { this.decreasetimeinbyinc(event, (1000 * 60)) }} > {ActualDateArrowDown()}</button>
                            </div>
                        </div>
                        <div className="flex-1 showBorder timecell-container align-contentCenter">
                            <div className="timecell-module showBorder align-contentCenter">
                                <button className="time-button general-button align-contentCenter" onClick={() => { this.toggletimeinampm("up") }}>{ActualDateArrowUp()}</button>
                            </div>
                            <div className="timecell-module showBorder align-contentCenter">
                                <input type="text" className="timeinput-field align-contentCenter titleFont" value={this.gettimeinampm()} />
                            </div>
                            <div className="timecell-module showBorder align-contentCenter">
                                <button className="time-button general-button align-contentCenter" onClick={() => { this.toggletimeinampm("down") }}> {ActualDateArrowDown()}</button>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex-1">
                    ...
                    <div className="general-flex">
                        <div className="flex-1">
                            ...
                            <div className="general-flex">
                                ...
                                <div className="flex-1 timedisplay-container align-contentCenter">
                                    <button className="general-button majorDownIcon" onClick={() => { this.activetimeoutcalendar() }}>{actualmajorDownIcon()}</button>
                                </div>
                            </div>
                    ...
                    <div className="general-flex">
                        <div className="flex-1 showBorder timecell-container">
                            ...
                            <div className="timecell-module showBorder align-contentCenter">
                                <button className="general-button time-button" onClick={event => { this.timeoutmonthup(event) }}>{ActualDateArrowUp()}</button>
                            </div>
                            <div className="timecell-module showBorder align-contentCenter">
                                <input type="text" className="timeinput-field align-contentCenter titleFont" value={this.gettimeoutmonth()} />
                            </div>
                            <div className="timecell-module showBorder align-contentCenter">
                                <button className="general-button time-button" onClick={event => { this.timeoutmonthdown(event) }}> {ActualDateArrowDown()}</button>
                            </div>
                        ...
                        <div className="flex-1 showBorder timecell-container align-contentCenter">
                            <div className="timecell-module showBorder">
                                <button className="general-button time-button" onClick={event => { this.increasetimeoutbyinc(event, (1000 * 60 * 60 * 24)) }}>{ActualDateArrowUp()}</button>
                            </div>
                            <div className="timecell-module showBorder align-contentCenter">
                                <input type="text" className="timeinput-field align-contentCenter titleFont" value={this.gettimeoutday()} />
                            </div>
                            <div className="timecell-module showBorder align-contentCenter">
                                <button className="general-button time-button" onClick={event => { this.decreasetimeoutbyinc(event, (1000 * 60 * 60 * 24)) }}> {ActualDateArrowDown()}</button>
                            </div>
                        ...
                        <div className="flex-1 showBorder timecell-container align-contentCenter">
                            <div className="timecell-module showBorder">
                                <button className="time-button general-button" onClick={event => { this.timeoutyearup(event) }}>{ActualDateArrowUp()}</button>
                            </div>
                            <div className="timecell-module showBorder align-contentCenter">
                                <input type="text" className="timeinput-field align-contentCenter titleFont" value={this.gettimeoutyear()} />
                            </div>
                            <div className="timecell-module showBorder align-contentCenter">
                                <button className="time-button general-button" onClick={event => { this.timeoutyeardown(event) }}> {ActualDateArrowDown()}</button>
                            </div>
                        </div>

                        <div className="flex-1 showBorder timecell-container">
                            <div className="timecell-module showBorder align-contentCenter">
                                <button className="time-button general-button align-contentCenter" onClick={event => { this.increasetimeoutbyinc(event, (1000 * 60 * 60)) }}>{ActualDateArrowUp()}</button>
                            </div>
                            <div className="timecell-module showBorder align-contentCenter">
                                <input type="text" className="timeinput-field align-contentCenter titleFont" value={this.gettimeouthours()} />
                            </div>
                            <div className="timecell-module showBorder align-contentCenter">
                                <button className="time-button general-button align-contentCenter" onClick={event => { this.decreasetimeoutbyinc(event, (1000 * 60 * 60)) }}> {ActualDateArrowDown()}</button>
                            </div>
                        </div>

                        <div className="flex-1 showBorder timecell-container">
                            <div className="timecell-module showBorder align-contentCenter">
                                <button className="time-button general-button align-contentCenter" onClick={event => { this.increasetimeoutbyinc(event, (1000 * 60)) }}>{ActualDateArrowUp()}</button>
                            </div>
                            <div className="timecell-module showBorder align-contentCenter">
                                <input type="text" className="timeinput-field align-contentCenter titleFont" value={this.gettimeoutminutes()} />
                            </div>
                            <div className="timecell-module showBorder align-contentCenter">
                                <button className="time-button general-button align-contentCenter" onClick={event => { this.decreasetimeoutbyinc(event, (1000 * 60)) }} > {ActualDateArrowDown()}</button>
                            </div>
                        </div>
                        <div className="flex-1 showBorder timecell-container align-contentCenter">
                            <div className="timecell-module showBorder align-contentCenter">
                                <button className="time-button general-button align-contentCenter" onClick={() => { this.toggletimeoutampm("up") }}>{ActualDateArrowUp()}</button>
                            </div>
                            <div className="timecell-module showBorder align-contentCenter">
                                <input type="text" className="timeinput-field align-contentCenter titleFont" value={this.gettimeoutampm()} />
                            </div>
                            <div className="timecell-module showBorder align-contentCenter">
                                <button className="time-button general-button align-contentCenter" onClick={() => { this.toggletimeoutampm("down") }}> {ActualDateArrowDown()}</button>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex-1">
                    ...
                    <div className="general-flex">
                        <div className="flex-1">
                            ...
                            <div className="align-contentCenter titleFont">Actual Labor</div>
                        </div>
                    </div>
