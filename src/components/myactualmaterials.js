...
class MyActualMaterials extends Component {
    ...
    handlemilestone(value) {
        if (this.state.activematerialid) {
                    ...
                    if (myproject.projectid === projectid) {
                        if (myproject.hasOwnProperty("actualmaterials")) {
                            ...
                            myproject.actualmaterials.mymaterial.map((mymaterial, j) => {
                                ...
                                if (mymaterial.materialid === materialid) {
                                    this.props.projectsprovider[i].actualmaterials.mymaterial[j].milestoneid = value;
                                    let obj = this.props.projectsprovider;
                                    this.props.projectsProvider(obj)
                                    this.setState({ render: 'render' })
                                }
            ...
            let mymaterial = ActualMaterial(materialid, providerid, projectid, datein, quantity, unit, unitcost, description, milestoneid, invoiceid)
            ...
            if (this.props.projectsprovider.hasOwnProperty("length")) {
                ...
                this.props.projectsprovider.map((myproject, i) => {
                    if (myproject.projectid === projectid) {
                        if (myproject.hasOwnProperty("actualmaterials")) {
                            this.props.projectsprovider[i].actualmaterials.mymaterial.push(mymaterial)
                            let obj = this.props.projectsprovider;
                            this.props.projectsProvider(obj)
                            ...
                            let actualmaterials = { mymaterial: material }
                            this.props.projectsprovider[i].actualmaterials = actualmaterials;
                            let obj = this.props.projectsprovider;
                            this.props.projectsProvider(obj)
                            this.setState({ activematerialid: materialid, message: `Active Material ID is ${materialid}, You are in Edit Mode` })
                        }
                    ...
                    if (myproject.projectid === projectid) {
                        if (myproject.hasOwnProperty("actualmaterials")) {
                            ...
                            myproject.actualmaterials.mymaterial.map((mymaterial, j) => {
                                ...
                                if (mymaterial.materialid === materialid) {
                                    this.props.projectsprovider[i].actualmaterials.mymaterial[j].description = value;
                                    let obj = this.props.projectsprovider;
                                    this.props.projectsProvider(obj)
                                    this.setState({ render: 'render' })
                                }
                    ...
                    if (myproject.projectid === projectid) {
                        if (myproject.hasOwnProperty("actualmaterials")) {
                            ...
                            myproject.actualmaterials.mymaterial.map((mymaterial, j) => {
                                ...
                                if (mymaterial.materialid === materialid) {
                                    this.props.projectsprovider[i].actualmaterials.mymaterial[j].quantity = value;
                                    let obj = this.props.projectsprovider;
                                    this.props.projectsProvider(obj)
                                    this.setState({ render: 'render' })
                                }
                    ...
                    if (myproject.projectid === projectid) {
                        if (myproject.hasOwnProperty("actualmaterials")) {
                            ...
                            myproject.actualmaterials.mymaterial.map((mymaterial, j) => {
                                ...
                                if (mymaterial.materialid === materialid) {
                                    this.props.projectsprovider[i].actualmaterials.mymaterial[j].unit = value;
                                    let obj = this.props.projectsprovider;
                                    this.props.projectsProvider(obj)
                                    this.setState({ render: 'render' })
                                }
                    ...
                    if (myproject.projectid === projectid) {
                        if (myproject.hasOwnProperty("actualmaterials")) {
                            ...
                            myproject.actualmaterials.mymaterial.map((mymaterial, j) => {
                                ...
                                if (mymaterial.materialid === materialid) {
                                    this.props.projectsprovider[i].actualmaterials.mymaterial[j].unitcost = value;
                                    let obj = this.props.projectsprovider;
                                    this.props.projectsProvider(obj)
                                    this.setState({ render: 'render' })
                                }
                ...
                this.props.projectsprovider.map((myproject, i) => {
                    ...
                    if (myproject.projectid === projectid) {
                        if (myproject.hasOwnProperty("actualmaterials")) {
                            ...
                            myproject.actualmaterials.mymaterial.map((mymaterial, j) => {
                                if (mymaterial.materialid === materialid) {
                                    this.props.projectsprovider[i].actualmaterials.mymaterial.splice(j, 1);
                                    let obj = this.props.projectsprovider;
                                    this.props.projectsProvider(obj);
